...
import { extractAndProtectLatex, restoreAndRenderLatexInHtml } from './latex-processor';
...
export async function parseMarkdownToNavigableHtml(
  ...
  let latexBlocks = new Map<string, any>();
  ...
  headingElements.forEach((el, index) => {
    ...
    // Add collapse arrow icon button
  ...
  // 5. Post-process Code Blocks: Add copy button
